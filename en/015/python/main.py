# Write a program that asks how many kilometers a rental car has traveled and how many days it has been rented. 
# Calculate the price to pay, knowing that the car costs $60 per day and $0.15 per mk driven.
